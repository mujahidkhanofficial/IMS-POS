...
function registerPurchaseHandlers() {
    ...
    electron_1.ipcMain.handle('db:purchases:getAll', () => {
    ...
    electron_1.ipcMain.handle('db:purchases:create', (_, { supplierId, invoiceNumber, items, date }) => {
        return (0, db_1.runQuery)(() => {
...
//# sourceMappingURL=db.purchases.js.map